        ...
        public override void Play()
        {
            ...
            foreach (Player player in Players)
            {
                ...
                while (!validAnswer)
                {
                    ...
                    if (!validAnswer) Console.WriteLine("Plese enter digits only, nodecimals.");
                }
                if (bet < 0)
                {
                    throw new FraudException("Security kick this guy out.");
                }
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (i == 1)
                {
                    ...
                    if (blackJack)
                    {
                        Console.WriteLine("Drats! Dealer has blackJack Everyone loses!");
